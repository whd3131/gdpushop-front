  ...
  <div class="table-classic-wrapper">
    ...
    <el-card shadow="always">
      ...
      >
        ...
        <el-form-item label="评分">
          <el-select v-model="listQuery.sex" placeholder="性别">
            <el-option :value="1" label="1分" />
            <el-option :value="2" label="2分" />
            <el-option :value="3" label="3分" />
            <el-option :value="4" label="4分" />
            <el-option :value="4" label="5分" />
      ...
      >
        ...
        <el-table-column prop="commentId" label="评论ID" width="120"  show-overflow-tooltip></el-table-column>
        <el-table-column prop="userId" label="用户ID" align="center" width="120"   show-overflow-tooltip/>
        <el-table-column prop="rate" label="评分" align="center" width="150" >
        ...
        <el-table-column prop="createTime" label="创建日期" align="center" width="120" show-overflow-tooltip sortable/>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        axios({
          method:'get',
          url:'http://localhost:8082/comment/getAllComment',
          headers:{
            admin:'admin'
          }
        }).then(res=>{
          this.tableData = res.data.data.commentInfoList
