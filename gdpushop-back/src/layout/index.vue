<template>
  <div class="app-wrapper">
    <div class="side-container" :class="collapsed ? 'folded' : 'unfolded'">
      <div class="logo">
        <a href="/">
<!--          <img style="height:80px;width:260px;background-color: slategrey" :src="imgSrc" alt="logo">-->
          <span style="text-align:center;font-size: 22px;color:white;font-weight: 900">
            广药商城后台系统
          </span>
        </a>
      </div>
...
import Logo from '../assets/img/gdpulogo.png'
